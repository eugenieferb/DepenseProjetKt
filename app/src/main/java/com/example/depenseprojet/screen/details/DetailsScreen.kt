package com.example.depenseprojet.screen.details
...
@Composable
fun DetailsScreen(navController: NavController, depenseId: String?){

    val depense: Depense = getDepense().filter { depense: Depense -> depense.id == depenseId }[0]
